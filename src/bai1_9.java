...
public class bai1_9 {
    ...
    public static int paymentBill(int unit){
        int money = 0;
        if(0<=unit && unit<=50){
            return money += 1480*unit;
        }
        else if(unit <= 100){
            return money += 1533*(unit-50) + paymentBill(50);
        }
        else if(unit <= 200){
            return money += 1786*(unit-100) + paymentBill(100);
        }
        else if(unit <= 300){
            return money += 2242*(unit-200) + paymentBill(200);
        }
        else{
            return money += 2503*(unit-300) + paymentBill(300);
        }
    }
